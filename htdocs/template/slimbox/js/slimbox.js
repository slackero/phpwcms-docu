...
var Lightbox = {
	...
	init: function(options){
		...
		this.captionWords = ['Image', 'of'];
		switch(browserLang) {
			case 'de':	this.captionWords = ['Bild', 'von']; break;
			case 'es':	this.captionWords = ['Imagen', 'de']; break;
			case 'fr':	this.captionWords = ['Image', 'de']; break;
			case 'nl':	this.captionWords = ['Afbeelding', 'van']; break;
			case 'da':	this.captionWords = []('billede', 'fra'); break;
		}
		// end enhancement
